...
describe('CommonContentRepository', () => {
    ...
    describe('upsert', () => {
        ...
        it('should handle upsert errors', async () => {
            ...
            await expect(repository.upsert({ key: 'test', data: {} })).rejects.toThrow(DatabaseError);
        });
    });
...
describe('PageContentRepository', () => {
    ...
    describe('upsert', () => {
        ...
        it('should handle upsert errors', async () => {
            ...
            await expect(repository.upsert({ slug: 'test', title: 'Test', data: {} })).rejects.toThrow(DatabaseError);
        });
    });
