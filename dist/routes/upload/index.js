 ...
 */
router.post('/image', requireAuth, uploadController.upload.single('file'), uploadController.uploadImage);
/**
 ...
 */
router.post('/images', requireAuth, uploadController.upload.array('files', 10), // Max 10 files
