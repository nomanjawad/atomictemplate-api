...
import { BannerSchema, CtaSchema, FAQSchema, GallerySchema } from '@atomictemplate/validations/common';
import { HomePageSchema, ContactPageSchema, GalleryPageSchema } from '@atomictemplate/validations/pages';
/**
 ...
 */
export function validateCommonContentData(key, data) {
    const schemaMap = {
        banner: BannerSchema,
        cta: CtaSchema,
        faq: FAQSchema,
 ...
 */
export function validatePageContentData(slug, data) {
    const schemaMap = {
        home: HomePageSchema,
