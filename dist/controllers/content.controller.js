 ...
 */
export async function listCommonContent(req, res, next) {
    try {
 ...
 */
export async function getCommonContent(req, res, next) {
    try {
 ...
 * Body: { data: {...} }
 */
export async function upsertCommonContent(req, res, next) {
    try {
        const { key } = req.params;
 ...
 */
export async function deleteCommonContent(req, res, next) {
    try {
        const { key } = req.params;
 ...
 */
export async function upsertPage(req, res, next) {
    try {
        const { slug } = req.params;
